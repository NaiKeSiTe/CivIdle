export const ZH_TW = {
   ...
   Acknowledge: "收到",
   Acropolis: "雅典衛城",
   AcropoliumOfCarthage: "迦太基—聖路易大教堂",
   ActorsGuild: "演員公會",
   ...
   Alloy: "合金",
   AllTransportsWithDistance3TileAreImmediate: "所有運輸距離小於或等於 3 地塊範圍，運輸資源不需要勞動者且運輸是即時（無運輸單位運輸）",
   Ally: "盟友",
   AlpineLogistics: "阿爾卑斯物流",
   Alps: "阿爾卑斯山",
   ...
   BatchSelectAllSameType: "所有相同建築",
   BatchSelectAnyType1Tile: "相鄰 1 格內的任意建築",
   BatchSelectAnyType2Tile: "相鄰 2 格內的任意建築",
   BatchSelectAnyType3Tile: "相鄰 3 格內的任意建築",
   BatchSelectSameType1Tile: "相鄰 1 格內的相同建築",
   BatchSelectSameType2Tile: "相鄰 2 格內的相同建築",
   BatchSelectSameType3Tile: "相鄰 3 格內的相同建築",
   BatchSelectSameTypeSameLevel: "相同等級相同建築",
   ...
   BuildingLevel: "建築等級",
   BuildingLevelBoost: "生產等級",
   BuildingLevelBoostDesc: "%{building} +%{value} 生產等級",
   BuildingLevelBoostFromElectrification: "現代化改造等級提供的生產等級",
   ...
   CathedralOfBrasiliaDesc:
      "如果周圍 2 地塊範圍的每個建築形成一個完整的生產鏈，即範圍內一個建築生產的資源被範圍內另一個建築消耗（範圍當中相同產出不同建築也會被歸入完整的生產鏈中），那麼參入該完整的生產鏈中的每種建築為其所有相同建築建築提供 +X 生產乘數。X = 生產鏈的總長度（建築種類數量，最大值為18。奇觀、旅館、倉庫、市場、克隆工廠和克隆實驗室除外）",
   CathedralOfBrasiliaWarningHTML: "為了形成生產鏈，一個建築生產的資源除了一種資源外（只能一種資源產出沒被✅），其他所有資源都需要被另一個建築消耗。（奇觀、旅館、倉庫、市場、克隆工廠和克隆實驗室除外）",
   Census: "人口普查",
   CentrePompidou: "蓬皮杜（Pompidou）中心",
   CentrePompidouDesc:
   ...
   ChateauFrontenacDesc: "該奇觀可被升級，每次升級時，將隨機抽取三種當前時代的建築。選擇其中一種建築來獲得 +1 生產等級（一旦選擇了就不能改變）",
   ...
   Cleopatra: "克麗奧佩脫拉",
   ClickToUnlockThisIdea: "點擊以解鎖此理念",
   ...
   Cosmodrome: "航天器發射場",
   CothonDockyards: "巨港造船廠",
   CothonOfCarthage: "巨港",
   CothonOfCarthageDesc: "解鎖迦太基文明理念",
   CothonOfCarthageLevel: "巨港等級",
   Cotton: "棉花",
   CottonMill: "紡織廠",
   ...
   DinosaurProvincialParkDesc: "該奇觀可手動進行啟動，獲得一批💵瑞士貨幣。（僅可啟動一次，價值等同於當前帝國總價值的 %{percent} ）",
   ...
   EachLevelOfCothonOfCarthageProvides1IdeaPoint: "巨港每一級提供 1 理念點數",
   EasterBunny: "復活節兔子",
   ...
   Enrichment: "鈾濃縮技術",
   EnricoFermi: "恩里科·費米",
   EnterExitMinimizedMode: "進入或退出懸浮窗模式",
   ...
   Festival: "節慶",
   FestivalCycle: "節慶週期",
   FestivalOfTanit: "坦提節：阿特拉斯山脈周圍擴大 2 地塊範圍並且額外提供生產等級",
   FestivalTechTooltipV2: "正向幸福值（最多 50）轉換為節慶點數，1 幸福= 1 節日點數。每累積 %{point} 節慶點數，可以讓您的帝國進入節慶週期，獲得特定地圖的重大加成。此地圖的節慶加成為 %{desc}",
   FestivalTechV2: "解鎖節慶功能 - 正向幸福值（最多 50）轉換為節慶點數，1 幸福= 1 節日點數。每累積 %{point} 節慶點數，可以讓您的帝國進入節慶週期，獲得特定地圖的重大加成",
   Feudalism: "封建主義",
   Fibonacci: "費波拉契",
   ...
   Gameplay: "遊戲設定",
   GangesRiver: "恒河",
   GangesRiverDescV3: "周圍 1 地塊範圍內的每種建築（產出工人建築除外），每種建築所有相同建築建築獲得 +N 生產乘數，N 為解鎖該建築時代的時代智慧等級",
   Garment: "服裝",
   GarmentWorkshop: "製衣廠",
   GasPipeline: "天然氣管道",
   ...
   GenerateOneTimeKotiEqualToXOfTheTotalBuildingValue: "一次性獲得一批💵瑞士貨幣。（價值等同於當前建築物總價值的 %{percent} ）",
   GenerateOneTimeKotiEqualToXOfTheTotalEmpireValue: "一次性獲得一批💵瑞士貨幣。（價值等同於當前帝國總價值的 %{percent} ）",
   GenerateOneTimeScienceEqualToTheCheapestTechnologyOfTheCurrentAge: "生成一批科學，生成量等同於當前時代最廉價科技所需",
   GenerateOneTimeScienceEqualToTheCostOfTheMostExpensiveTechnologyOfTheCurrentAge: "生成一批科學，生成量等同於當前時代最昂貴科技所需",
   GenerateOneTimeWarpThatRefillsAllAvailableWarpStorage: "一次性填滿扭曲時間存儲",
   Genetics: "遺傳學",
   GenghisKhan: "成吉思汗",
   ...
   GreatOceanRoad: "大洋路",
   GreatOceanRoadDesc: "該奇觀可被升級，每一級為貿易地塊加成對應建築提供 +1 生產等級（不包括相鄰玩家加成，相同地塊僅生效一次）",
   GreatPeople: "偉人",
   ...
   GreatPeoplePickPerRoll: "偉人每次選擇數",
   GreatPeopleShardsAcquired: "獲得的偉人碎片",
   ...
   Habitat67: "棲息地67住宅區",
   Habitat67DescV2: "該奇觀可被升級，每一級為AI實驗室提供 +1 生產、勞動者能力以及存儲乘數。為AI實驗室提供 +N 生產和存儲乘數，N 為資訊時代智慧等級。每有正向 5 幸福感（最大值為 50 ）為AI實驗室提供 +1 生產等級",
   HafsidDynasty: "哈夫斯王朝",
   HagiaSophia: "聖索菲亞大教堂",
   ...
   Hannibal: "漢尼拔·巴卡",
   HannibalSStrategy: "漢尼拔的戰略",
   HannoTheNavigator: "漢諾",
   Happiness: "幸福感",
   ...
   House: "房屋",
   Housing: "住宅",
   HusainidDynasty: "侯賽因王朝",
   Hut: "小屋",
   HydroDam: "水壩",
   Hydroelectricity: "水力發電",
   HymanGRickover: "海曼·李高佛(Hyman G. Rickover)",
   IberianColonies: "伊比利亞殖民地",
   IdeologyDescHTML: "使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>自由主義、保守主義、社會主義或共產主義</b>中選擇作為您的帝國政治意識形態。選擇後，您<b>無法切換意識形態</b>。您可以在每個政治意識形態中解鎖更多的增益。",
   IMPei: "貝聿銘",
   ...
   ItaipuDam: "伊泰普大壩",
   ItaipuDamDesc: "該奇觀可被升級，並且每一次額外升級，為周圍 2 地塊範圍的建築提供 +1 生產乘數或 +1 生產等級（可自由分配每+1加成）。為周圍 2 地塊範圍提供電力。",
   ...
   KingDavid: "大衛王",
   KizhiPogost: "基日鄉村教堂",
   KizhiPogostDescV2: "周圍 3 地塊範圍內的所有建築獲得 +N 生產乘數，N 為該奇觀獲得的生產乘數（生產乘數可來自：戴森球、蓬皮杜文藝中心、聖家族大教堂等通用加成奇觀）",
   Knight: "騎士",
   KnightCamp: "騎士營地",
   Koti: "💵瑞士貨幣",
   KotiInStorage: "已存儲",
   ...
   LakeLouise: "路易斯湖",
   LakeLouiseDesc: "貿易地圖上所有相鄰玩家都視為盟友（某些情況下仍會顯示非盟友）。每位盟友的地塊為對應建築提供 +2 生產等級",
   LandTrade: "商學",
   Language: "語言",
   Laozi: "老子",
   Lapland: "拉普蘭",
   ...
   LiberalismLevel4DescHTML: "所有發電廠 +1 生產乘數",
   LiberalismLevel5DescHTMLV3: "所有可現代化改造的建築額外獲得<b> +5 生產等級</b>",
   ...
   Maslenitsa: "送冬節: 基日鄉村教堂的範圍增加至周圍 6 地塊範圍。貝加爾湖的範圍增加至周圍 4 地塊範圍。羅蒙諾索夫院士號產出的電力雙倍",
   Masonry: "石匠技術",
   ...
   Meat: "肉",
   MedinaOfTunis: "突尼斯—麥地那",
   MediterraneanTrades: "地中海貿易",
   MercenaryCommand: "雇傭兵指揮官",
   MerchantFleet: "商船艦隊",
   Metallurgy: "冶煉",
   ...
   MiddleClickDescHTML: "選取你要<b>複製藍圖的建築</b>（包括建造中的）點擊，別點擊任何地塊！直接<b>按滑鼠中鍵</b>指著想要建設相同建築建築的地塊",
   MilitaryTactics: "軍事戰略",
   Milk: "牛奶",
   MinusXResearchCost: "-%{percent} 科學所需",
   MirrorServer: "鏡像伺服器",
   Moai: "復活節島摩艾石像",
   ...
   NoKotiExport: "禁止對外輸出💵瑞士貨幣",
   NoKotiExportDesc: "建築將不能從瑞士銀行中運輸💵瑞士貨幣——他們仍然可以從其他非瑞士銀行的建築中運輸💵瑞士貨幣",
   ...
   OpetV2: "歐佩特：獅身人面像額外为範圍 2 格內所有二階或以上建築 +N 生產等級，N = 與受益建築相鄰的同類建築數量。",
   OpticalFiber: "光纖",
   ...
   Petra: "佩特拉古城",
   PetraDescV3: "解鎖更多扭曲倍速。該奇觀可以升級，每一級提供 1 小時的扭曲存儲。當你離線時生成扭曲時間，你可以用來加速你的帝國或攜帶最多 4 小時（14.4K）扭曲時間到重生後的地圖（可在右上角的選項-遊戲設置-離線生產欄裏分配離線設置）",
   ...
   PinResourceTab: "懸浮窗",
   PinTodo: "頂置",
   PinTodoTooltip: "將待處理提示頂置在最左邊的位置",
   Pizza: "披薩",
   Pizzeria: "披薩店",
   ...
   Plus2RangeForBuildings: " %{buildings} 周圍擴大 2 地塊範圍",
   PlusAtlasMountainsRange: "阿特拉斯山脈周圍擴大 %{range} 地塊範圍",
   PlusXAgeWisdom: "%{age} 時代智慧獲得 +%{percent} 加成效果",
   PlusXBaseStorageForMarketWarehouseAndCaravansary: "所有市場、商隊旅館以及倉庫，獲得 +%{percent} 基礎存儲能力",
   PlusXGreatPeopleFromTheCurrentAge: "獲得 %{count} 當前時代偉人",
   ...
   PublishingHouse: "出版社",
   PunicCoinage: "布匿貨幣",
   PunicGoldenAge: "布匿黃金時代",
   PunicLegalCodex: "布匿法律法典",
   PurpleDyeMonopoly: "紫色染料壟斷",
   ...
   RedFort: "紅堡",
   RedFortDesc: "周圍 3 地塊範圍內的所有建築獲得 +1 生產等級。該奇觀可被升級，並且每一次額外升級為周圍 3 地塊範圍內的所有建築提供 +1 生產等級",
   ...
   ReligionDescHTML: "使用<b>滑鼠滾輪或右邊的滾動條</b>，從<b>基督教、伊斯蘭教、佛教與多神教</b>中選擇一個，作為帝國宗教。你將<b>不能更換宗教</b>。不同宗教將能解鎖不同增益效果",
   ReligionIslam: "伊斯蘭教",
   ...
   ResourceExportToSameType: "運輸到相同建築",
   ResourceExportToSameTypeTooltip: "允許相同建築其他建築從該建築運輸資源",
   ...
   RestitutorDescHTML: "添加我即將推出的遊戲到願望清單中——<b>《光復者：帝國重鑄》</b>。這是一款以歷史為背景的漸進式大戰略遊戲，側重於<i>治國之道、外交以及精心策劃的戰爭</i>。遊戲設定在西元 192 年康茂德去世後的羅馬帝國時期，當時帝國分裂為相互對立的省份。作為總督，選擇一個省份作為你的領地並努力恢復帝國。",
   ...
   RoyalFlycatcherDesc: "周圍 2 地塊範圍內的所有建築獲得 +X 生產等級。 X = 該奇觀範圍內空白地塊數量",
   ...
   SelectAdaptiveGreatPeopleBoost: "未選擇的建築偉人提示",
   ...
   StatueOfLibertyDesc: "所有相鄰建築，獲得 +N 生產、工人能力以及存儲乘數。 N = 相鄰相同建築建築數量",
   StatueOfZeus: "宙斯神像",
   ...
   Surplus: "赤字",
   SwissBank: "瑞士銀行",
   SwissBankDescV3: "從所有可與玩家交易的資源（旅館存儲或與旅館相鄰的倉庫存儲）中選擇一種資源轉換為💵瑞士貨幣。每個週期基礎產出1個💵瑞士貨幣（可被生產乘數影響），該奇觀可被升級，並且每一次額外升級增加 1 基礎產出（無論基礎產出提升還是生產乘數提升都只是提升每週期等價兌換最大總數量）。瑞士銀行可以存儲無限量的💵瑞士貨幣",
   Sword: "劍",
   SwordForge: "鑄劍廠",
   ...
   TutorialBuildWheatFarmHTML: "要快速建造大量的建築，你可以<b>選擇一個建築地塊</b>，別點擊任何地塊！直接<b>按滑鼠中鍵</b>指著想要建設相同建築建築的地塊——這將自動複製選定的建築到空白地塊上。",
   ...
   UNGeneralAssemblyCurrent: "本周生效聯合國大會 #%{id} 決議效果",
   UNGeneralAssemblyNext: "下周生效聯合國大會 #%{id} 決議效果",
   UNGeneralAssemblyVoteEndIn: "您可以在<b>%{time}</b>投票結束之前隨時更改投票",
   UniqueBuildings: "獨特建築",
   UniqueEffects: "獨特的效果",
   UniquePermanentGreatPeople: "生效永久偉人種類",
   ...
   Wine: "葡萄酒",
   Winery: "葡萄酒廠",
   WinterCarnival: "冬季嘉年華：北極光的範圍增加至周圍 4 地塊範圍。弗朗特納克城堡和棲息地67住宅區提供生產等級翻倍",
   WishlistRestitutor: "《光復者：帝國重鑄》願望單",
   ...
   WorldTradeOrganizationDesc: "該奇觀可被升級，每一級為擁有的貿易地塊加成額外提供 +1 生產乘數（相同地塊同樣生效，不包括相鄰玩家加成）。參加每週世界貿易組織大會，在世界貿易組織大會上獲選的建築將增加在貿易地圖上的數量",
   WorldWarAge: "世界大戰",
   WorldWideWeb: "全球資訊網",
   WritersGuild: "作家公會",
   Writing: "文字",
   WTOVoteCurrent: "本周生效世界貿易組織大會 #%{id} 投票效果",
   WTOVoteDescriptionHTML: "在世界貿易組織大會上獲選的建築將增加在<b>貿易地圖上的數量</b>",
   WTOVoteNext: "下周生效世界貿易組織大會 #%{id} 投票效果",
   WuZetian: "武則天",
   ...
   XhWarpStorageThisRun: "本輪增加 %{hour} 小時扭曲存儲",
   ...
   YouHaveAdaptiveGreatPeopleWithBoostToSelect: "您擁有的建築偉人未選擇相應建築，點擊此提示選擇它們",
   YuriGagarin: "尤里·加加林",
