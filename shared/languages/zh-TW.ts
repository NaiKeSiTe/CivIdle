export const ZH_TW = {
   ...
   ActualElectrificationLevel: "實際電氣化等級<b>以建築等級為上限</b>",
   ...
   AdvisorElectricityContentV2:
      "發電廠建築為你提供了兩種新系統。第一種是「電力」，與電廠相鄰地塊以閃電圖示顯示。一些建築物（如世界大戰時期的建築廣播電台）在其輸入列表中會顯示「需要電力」的指示。<b>這意味著它們必須建在具有閃電圖示的地塊上才能運作</b>。需要電力的建築物如果有電力支持，也會將電力傳輸到該建築物相鄰的地塊，因此只要有一個建築物接觸到電廠，其它建築物就可以彼此供電。<br><br>另一個系統是「電氣化」，只要不是生產科學或工人的建築物，就可以將其應用到<b>地圖上的任何建築物</b>。這會消耗電廠產生的電力，以增加建築物的消耗和生產。更高的電氣化等級需要消耗越來越多的電力。對「需要電力」的建築物可以從電氣化中額外獲得 +5 建築等級。",
   ...
   BrandenburgGateDesc: "所有煤礦與油井，獲得 +1 生產、工人能力以及存儲乘數。與煉油廠相鄰的每個含原油資源地塊，使煉油廠獲得 +1 生產、工人能力以及存儲乘數",
   Brasilia: "巴西利亞",
   Brazilian: "巴西",
   Bread: "麵包",
   Brewery: "釀酒廠",
   ...
   BuildingLevelBoostFromElectrification: "電氣化等級提供的建築等級",
   ...
   CathedralOfBrasiliaDesc: "如果周圍 2 地塊範圍的每個建築形成一個完整的生產鏈（上游各分支也計入在內），即一個建築生產的資源被另一個建築消耗，那麼參入該完整生產鏈中的每種建築為所有同類型建築提供 +X 生產乘數。X = 生產鏈的總長度（建築種類數量，最大值為18）",
   CathedralOfBrasiliaWarningHTML: "為了形成生產鏈，一個建築生產的資源除了一種資源外，其他所有資源都需要被另一個建築消耗（奇觀、旅館、倉庫、市場、克隆工廠和克隆實驗室除外）",
   Census: "人口普查",
   ...
   DefaultElectrificationLevel: "預設電氣化等級",
   DefaultProductionPriority: "預設生產優先等級",
   DefaultProductionPriorityForBuildingsThatProduceWorkers: "產出工人建築預設生產優先等級",
   ...
   EasterBunny: "復活節兔子",
   EasterBunnyDesc: "建造完成後，重生時將複製 10％ 額外偉人將以此生偉人方式進入下輪遊玩不再以永恆碎片，並在下輪遊玩中建造復活節兔子後根據已解鎖時代誕生這些偉人。此奇觀僅在 4 月可建造。",
   ...
   Electricity: "電力",
   Electrification: "電氣化",
   ElectrificationLevel: "電氣化等級",
   ElectrificationPowerRequired: "需要供電",
   ElectrificationStatusActive: "啟用",
   ElectrificationStatusDescV2: "需要與不需要電力的建築都可以電氣化。然而，需要電力的建築可以從電氣化中額外獲得 +5 建築等級。",
   ...
   LiberalismLevel5DescHTMLV3: "所有可電氣化的建築額外獲得<b> +5 建築等級</b>",
   ...
   ManhattanProjectDesc: "所有鈾礦獲得 +2 生產、工人能力以及存儲乘數 。與鈾礦相鄰的鈾濃縮場與原子能設施的生產乘數 +1 ",
   ...
   MatrioshkaBrainDescV2: "允許科學在計算帝國價值時被計入（5 科學 = 1 帝國價值）。每個忙碌和閒置的工人提供 +5 科學。此奇觀可升級，每次升級額外提供 +1 科學和生產乘數",
   ...
   NotEnoughPowerHTML: "%{count} 建築沒有電氣化，因為它們的沒有足夠電力，點擊高亮它們",
   NothingHere: "此處沒有東西",
   ...
   Pamukkale: "棉花城堡",
   PamukkaleDesc: "當此奇觀被發現時，將所有每個偉人（萬能偉人和媒介偉人除外）消耗 1 偉人碎片（可用偉人碎片需要大於0才能轉換）轉換為本輪遊玩中的同一偉人（此生偉人）",
   ...
   Petra: "佩特拉古城",
   PetraDescV2: "解鎖更高扭曲倍速，該奇觀可以升級，每一級提供 1 小時的扭曲存儲。當你離線時生成扭曲時間，你可以用來加速你的帝國",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDescV2: "建造完成後，誕生一個除當前時代之外的其他時代偉人。該奇觀可被升級，並且每一次升級都會誕生一個除當前時代之外的其他時代偉人。（偉人隨機區間：青銅~資訊）當從這座奇觀進行偉人選擇時，每位偉人有 2 項可選。",
   ...
   Spinner: "運轉動畫",
   SpinnerSpeed: "運轉動畫速度",
   SpinnerSpeedDescHTML: "調整運轉動畫的速度，作為區分電氣化的建築運轉動畫速度為兩倍。<b>調整值必須位於0.01到100之間。默認值為1</b>（調整運轉動畫的速度不會影響每週期生產）",
   Sports: "體育運動",
   Stable: "馬廄",
   Stadium: "體育場",
   StartFestival: "節慶狂歡！",
   ...
   StatisticsTotalTransportation: "運輸單位數量",
   ...
   TempleOfPtah: "卜塔神殿",
   TerracottaArmy: "兵馬俑",
   TerracottaArmyDesc: "所有鐵礦 +1 生產、工人能力以及存儲乘數。與鐵鍛鋪相鄰的每個含鐵資源地塊的鐵礦，使鐵鍛鋪獲得 +1 生產乘數",
   ...
   TutorialEnterClassicalAgeHTML: "你的帝國將在研究完古典時代的任何科技後進入古典時代。你可以從古典時代、鐵器時代和青銅時代各挑選一個偉人。",
   ...
   TutorialRebirthHTML: "當你覺得進展緩慢時，你應該考慮重生。當重生時，此生偉人將成為永恆偉人碎片，可以用來升級永恆偉人。你可以選擇不同的文明——每個文明都有自己獨特的內容。",
   ...
   TutorialResearchHousingHTML: "研究住宅科技解鎖<b>房屋</b>，比小屋能提供更多的工人。在研究住宅之後，你的帝國將進入<b>青銅時代</b>，一個青銅時代的偉人將誕生。你可以從三個選擇中選擇一個偉人，偉人會給你很大的幫助——明智地選擇。",
   TutorialResearchLandTradeTechHTML: "通過研究路上貿易，你的帝國將進入鐵器時代。你可以從鐵器時代和青銅時代各挑選一個偉人。路上貿易科技也解鎖商隊旅館。",
   ...
   UnclaimedPermanentGreatPeople: "未領取的永恆偉人提示",
   UnclaimedPermanentGreatPeopleHTML: "你有 <b>%{count}</b> 未領取的永恆偉人，點擊歡迎他們",
   ...
   UpgradeablePermanentGreatPeople: "可升級的永恆偉人提示",
   UpgradeablePermanentGreatPeopleHTML: "以下永恆偉人可以升級：<b>%{gps}</b>",
   UpgradeBuilding: "升級",
   ...
   YearOfTheSnake: "巳蛇",
   YearOfTheSnakeDesc: "建成後，當進入一個新時代時，將原本每個已解鎖時代獲得一位偉人，改為獲得相同數量的當代偉人。周圍 2 格範圍內的所有建築獲得 +1 的生產加成乘數。此世界奇觀可升級，每次額外升級會為周圍 2 格範圍內的所有建築再提供 +1 的生產加成乘數。此奇觀僅能在農曆新年期間（1 月 20 日至 2 月 10 日）建造。",
   YellowCraneTower: "黃鶴樓",
   YellowCraneTowerDesc: "選擇偉人時 +1 選擇。 1 格範圍內的所有建築能獲得 +1 生產、工人能力以及存儲乘數。若建造在長江旁，範圍增加到 2 格",
   YouAreOffline: "您已離線提示",
