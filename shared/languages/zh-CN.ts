export const ZH_CN = {
   ...
   BitcoinMiner: "比特币矿工",
   BlackForest: "黑森林",
   BlackForestDesc: "被发现时，显露地图上的所有原木资源地块。在其相邻地块生成原木资源。所有消耗原木或木板的建筑，获得 +5 生产乘数",
   Blacksmith: "工匠铺",
   Blockchain: "区块链",
   BobHope: "鲍勃·霍普",
   ...
   Language: "语言",
   Lapland: "拉普兰区",
   LaplandDesc: "被发现时，显示完整地图。周围 2 地块范围内的所有建筑，获得+n生产乘数,n=已解锁时代的数量。该自然奇观仅可被发现于十二月",
   ...
   OfflineProductionTimeDescHTML: "对于<b>first %{time} offline time</b>您可以选择离线生产或扭曲时间——你可以在这里设置分割把<b>rest of the offline time</b>只能转换为扭曲时间",
   OfflineTime: "离线时间",
   Oil: "石油",
   OilPress: "榨油机",
   OilRefinery: "炼油厂",
   ...
   Theocracy: "神权",
   ThePentagon: "五角大楼",
   ThePentagonDesc: "建造完成后，生成可用于移动非奇观建筑的搬迁队。2格范围内的所有建筑+1生产，劳动者能力和储存乘数",
   TheWhiteHouse: "白宫",
