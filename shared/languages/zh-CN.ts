export const ZH_CN = {
   ...
   ActualElectrificationLevel: "实际电气化等级<b>以建筑等级为上限</b>",
   ...
   BranCastle: "布朗城堡",
   BranCastleDescV2: "该奇观产出的劳动者等同于周围 3 地块范围内的劳动者总产出。如果有足够的劳动者，还会将该奇观产出的劳动者转化为吸血鬼。吸血鬼不参与生产或运输资源，但被视为忙碌的劳动者。布郎城堡的等级由劳动者总数决定，每一级获得 +1 闲置劳动者科学产出和 +2 忙碌劳动者科学产出。该奇观只能在万圣节（10.15 ~ 11.15）期间建造。",
   ...
   BuildingLevelBoostFromElectrification: "电气化等级提供的建筑等级",
   ...
   CathedralOfBrasiliaDesc: "如果周围 2 地块范围的每个建筑形成一个完整的生产链，即一个建筑生产的资源被另一个建筑消耗（当中相同产出资源的另一条生产链也会被归入完整的生产链中），那么参入该完整的生产链中的每种建筑为其所有同类型建筑提供 +X 生产乘数。X = 生产链的总长度（建筑种类数量——同产出不同类型建筑也生效，最大值为18。奇观、旅馆、仓库、市场、克隆工厂和克隆实验室除外）",
   ...
   DefaultElectrificationLevel: "默认电气化等级",
   DefaultProductionPriority: "默认生产优先级",
   DefaultProductionPriorityForBuildingsThatProduceWorkers: "产出劳动者建筑默认生产优先级",
   ...
   ElbphilharmonieDesc: "周围 3 地块范围内的所有建筑，A建筑每相邻不同于A建筑的阶且运转的建筑，则A建筑建筑获得 +1 生产乘数（例：伐木场( I 阶)相邻邻3个砖窑( II 阶)，伐木场获得+3生产乘数）",
   Electricity: "电能",
   Electrification: "电气化",
   ElectrificationLevel: "电气化等级",
   ElectrificationPowerRequired: "所需功率",
   ElectrificationStatusActive: "运转中",
   ElectrificationStatusDescV2: "无论建筑是否需要电力，都存在电气化可能。不同之处在于，需要电力的建筑可以从电气化中额外获得 +5 建筑等级（额外的建筑等级——其将不会影响劳动者与存储）",
   ...
   EuphratesRiverDesc:
      "从事生产（非运输）的忙碌劳动者占比每有 10% ，为之前时代的所有已解锁建筑（产出劳动者建筑除外），提供 +1 生产乘数（每个时代最大值如下：石器至铁器为1，古典至中世纪为2,文艺复兴至工业为3，世界大战至冷战为4，信息为5）。当空中花园在其旁建造完成，基于空中花园解锁后的每个时代，使空中花园获得 +1 效果。当此奇观被发现时，与该奇观相邻无沉积资源的地块生成水资源",
   ...
   GoldenPavilion: "金阁寺",
   GoldenPavilionDesc: "周围 3 地块范围内的所有建筑，A建筑相邻B建筑，且B生产是A消耗任意所需，则A建筑获得 +1 生产乘数（克隆实验室与克隆工厂除外,需建筑都运转。例：石雕铺相邻3个工匠铺，石雕铺获得+3生产乘数）",
   GoldMiningCamp: "金矿",
   GordonMoore: "戈登·摩尔",
   GrandBazaar: "大巴扎",
   ...
   LiberalismLevel5DescHTMLV3: "所有可电气化的建筑额外获得<b> +5 建筑等级</b>",
   ...
   MountSinai: "西奈山",
   MountSinaiDesc: "当此奇观被发现后，诞生一个当前时代的伟人。所有产出信仰的建筑，获得 +5 存储乘数",
   MountTai: "泰山",
   ...
   NotEnoughPowerHTML: "%{count} 建筑没有电气化，因为它们的没有足够电能，点击高亮它们",
   NothingHere: "此处无可显示项",
   ...
   OsakaCastle: "大阪城",
   OsakaCastleDesc: "为周围 2 地块范围提供电力。允许产出科学的建筑使用电气化（包括克隆实验室）",
   ...
   Petra: "佩特拉",
   PetraDescV2: "解锁更高扭曲倍速，该奇观可以升级，每一级提供 1 小时的扭曲存储。当你离线时生成扭曲时间，你可以用来加速你的帝国",
   ...
   PlayerMapRanking: "排名",
   PlayerMapRankingDesc: "相同旗帜的贸易地块数量排名",
   ...
   PorcelainTowerDesc: "+5 幸福感。建造完成时，你重生时可获取的当前额外伟人，将可在本轮提前获取（他们与永恒伟人遵循相同的获取规则）并在获取后提供相应此生伟人加成（之后新增的额外伟人不可再次本轮获取）",
   ...
   QinShiHuang: "秦始皇",
   QutbMinar: "古特伯高塔",
   QutbMinarDescV2: "建造完成后，诞生一个除当前时代之外的其他时代伟人。该奇观可被升级，并且每一次升级都会诞生一个除当前时代之外的其他时代伟人。（伟人随机区间：青铜~信息）当从这座奇观进行伟人选择时，每位伟人有 2 项可选。",
   ...
   Samsuiluna: "萨姆苏·伊路那",
   SanchiStupa: "桑奇大塔",
   SanchiStupaDesc: "周围 2 地块范围内所有建筑，对于范围内建筑 “输出” 与 “输入” 的资源调用，免费运输且运输是即时（无运输单位运输）",
   Sand: "沙",
   Sandpit: "采沙坑",
   ...
   Spinner: "运转动画",
   SpinnerSpeed: "运转动画速度",
   SpinnerSpeedDescHTML: "调整运转动画的速度，作为区分电气化的建筑运转动画速度为两倍。<b>调整值必须位于0.01到100之间。默认值为1</b>（调整运转动画的速度不会影响每周期生产）",
   Sports: "体育运动",
   Stable: "马厩",
   Stadium: "体育场",
   StartFestival: "欢度佳节吧！",
   ...
   TutorialEnterClassicalAgeHTML: "你的帝国将在研究完古典时代的任何科技后进入古典时代。你可以从古典时代、铁器时代和青铜时代各挑选一个伟人。",
   ...
   TutorialResearchHousingHTML: "研究住宅科技解锁<b>房屋</b>，比小棚屋能提供更多的劳动者。在研究住宅之后，你的帝国将进入<b>青铜时代</b>，一个青铜时代的伟人将诞生。你可以从三个选择中选择一个伟人，伟人会给你很大的帮助——明智地选择。",
   TutorialResearchLandTradeTechHTML: "通过研究路上贸易，你的帝国将进入铁器时代。你可以从铁器时代和青铜时代各挑选一个伟人。路上贸易科技也解锁商队旅馆。",
   ...
   UNGeneralAssemblyMultipliersV2: "<b>+%{count}</b> 生产乘数。作用于：<b>%{buildings}</b>",
   ...
   ZhengHe: "郑和",
   ZigguratOfUr: "乌尔大塔庙",
   ZigguratOfUrDescV2: "每有正向 10 幸福感（最大值为 50），为之前时代的所有已解锁建筑（产出劳动者建筑除外），提供 +1 生产乘数（每个时代最大值如下：古典至中世纪为2,文艺复兴至工业为3，世界大战至冷战为4，信息为5）。奇观（包括自然奇观）不再提供 +1 幸福感。效果可关闭。",
   Zoroaster: "琐罗亚斯德",
   Zugspitze: "楚格峰",
